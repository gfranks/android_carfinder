...
public class PagerTitleStrip extends ViewGroup implements ViewPager.Decor {
    ...
    private OnPagerTitleClickListener onPagerTitleClickListener;
    ...
    public void setOnPagerTitleClickListener(OnPagerTitleClickListener listener) {
    	this.onPagerTitleClickListener = listener;
    }
    ...
    void updateText(final int currentItem, PagerAdapter adapter) {
        ...
        mPrevText.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (onPagerTitleClickListener != null) {
					onPagerTitleClickListener.onPagerTitleSelected(currentItem-1);
				}
			}
        });
